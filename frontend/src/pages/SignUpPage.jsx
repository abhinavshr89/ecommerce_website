...
import { UserPlus, Mail, Lock, User, ArrowRight, Loader,EyeClosed,EyeIcon } from "lucide-react";
            ...
            <div>
              ...
              <div className='mt-1 relative rounded-md shadow-sm'>
                ...
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer" onClick={() => setShowPassword(!showPassword)}>
                  {showPassword ? <EyeIcon className='h-5 w-5 text-gray-400' aria-hidden='true' /> : <EyeClosed className='h-5 w-5 text-gray-400' aria-hidden='true' />}
                </div>
              </div>
            </div>
